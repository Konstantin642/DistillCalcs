...
1) Create a text document. In the first two lines, write the molecular masses of components #1 and #2:
    - M_1=...
    - M_2=...
...
2) Place the created file in the "data" folder. Copy the name of the created file to the "equlibrium_data_fileName" variable.

3) Specify the mole fractions of component #1:
